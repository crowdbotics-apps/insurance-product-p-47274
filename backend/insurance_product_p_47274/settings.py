"""
Django settings for insurance_product_p_47274 project.
...
ROOT_URLCONF = 'insurance_product_p_47274.urls'
...
WSGI_APPLICATION = 'insurance_product_p_47274.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "insurance_product_p_47274 API",
    "DESCRIPTION": "API documentation for insurance_product_p_47274 App",
    "VERSION": "v1",
}
